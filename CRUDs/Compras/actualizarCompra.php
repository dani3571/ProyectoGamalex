<?php 
    ...
    $id=$_GET['id'];
    $sql2="SELECT * FROM compra WHERE IdCompra='$id'";
    ...
    <body>
        ...
        <div class="form">
            <form action="./updateCompra.php" method="POST">
                <h2 class="form_title">Actualize los datos de la Compra</h2>
                <div class="form_container">
                    <div class="form_group">
                        <input type="number" id="IdCompra" placeholder=" " name="IdCompra"  class="form_input"value="<?php echo $row2['IdCompra']  ?>" readonly>
                        <label for="IdCompra" class="form_label">Id Compra:</label>
