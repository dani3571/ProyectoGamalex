...
<div class="w-full h-full">
                         ...
                         <h1 style="font-size: 40px; color:antiquewhite;">Farmacia Gamalex</h1>
                            ...
                            <ul class="mt-12">
                                ...
                                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                    <a href="../CRUDs/Laboratorios/index.php" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                        ...
                                        <span class="text-sm ml-2">Laboratorios</span>
                                    </a>

                                </li>
                                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                    <a href="../CRUDs/Productos/Index.php" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                        ...
                                        <span class="text-sm ml-2">Productos</span>
                                    </a>
                                </li>
                                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                    <a href="../CRUDs/Ventas/Index.php" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
                                        ...
                                        <span class="text-sm ml-2">Ventas</span>
                                    </a>
                                </li>
                                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                    <a href="../CRUDs/Compras/Index.php" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-puzzle" width="18" height="18" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z"></path>
                                            <path d="M4 7h3a1 1 0 0 0 1 -1v-1a2 2 0 0 1 4 0v1a1 1 0 0 0 1 1h3a1 1 0 0 1 1 1v3a1 1 0 0 0 1 1h1a2 2 0 0 1 0 4h-1a1 1 0 0 0 -1 1v3a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-1a2 2 0 0 0 -4 0v1a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h1a2 2 0 0 0 0 -4h-1a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1"></path>
                                        </svg>
                                        <span class="text-sm ml-2">Compras</span>
                                    </a>
                                </li>
                                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                                    <a href="../CRUDs/Usuarios/Index.php" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center">
                                    <a href="../CRUDs/Clientes/Clientes.php" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                        ...
                                        <span class="text-sm ml-2">Clientes</span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="w-64 z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav">
                        ...
                        <div class="px-8">
                            <div class="h-16 w-full flex items-center">
                                <svg aria-label="GAMALEX. Logo"role="img" xmlns="http://www.w3.org/2000/svg" width="144" height="30" viewBox="0 0 144 30">
                                    <path
                                        fill="#5F7DF2"
          ...
          ?>
            <div class="flex items-center justify-between p-5 bg-white rounded shadow-sm">
              <div>
                <div class="text-sm text-gray-400 ">Cantidad de productos registrados</div>
                <div class="flex items-center pt-1">
                  <div class="text-3xl font-medium text-gray-600 "><?php 
                       $query = "SELECT COUNT(Cantidad) as Cantidad FROM producto";
...
<div id="posicion2">
<!--Ultimas ventas-->
    <div class="flex flex-col justify-left h-full">
        <!-- Table -->
        <div class="w-max max-w-2xl left cartamx-auto bg-white shadow-lg rounded-sm border border-gray-200">
            <header class="px-5 py-4 border-b border-gray-100">
                <div class="font-semibold text-gray-800">Ultimas ventas</div>
            </header>
            ...
            <div class="overflow-x-auto p-3">
                <table class="table-auto w-full">
                    <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                        <tr>
                            <th class="p-2">
                            <div class="font-semibold text-left">Id Venta</div>
                            </th>
                            <th class="p-2">
                                <div class="font-semibold text-left">Producto</div>
                            </th>
                            <th class="p-2">
                                <div class="font-semibold text-left">Venta total</div>
                            </th>
                            <th class="p-2">
                ...
                <?php
			$query = "SELECT c.IdVenta,b.Nombre, c.FechaVenta, SUM(c.Cantidad * b.PrecioUnidad) as suma FROM `detalleventa` a INNER JOIN producto b on a.IdProducto = b.IdProducto INNER JOIN venta c on a.IdVenta = c.IdVenta GROUP BY b.Nombre LIMIT 0, 3 ";
			...
			if($stmt->rowCount() > 0) {
                ...
                <td class="p-2">
                      <div class="text-left"><?php echo $suma; ?></div>
                </td>
				...
				?>
		        <tr>
		        <td colspan="3">No hay ventas en lista</td>
		        </tr>
		        <?php
...
<div class="flex flex-col justify-top h-max">
        ...
        <header class="px-5 py-4 border-b border-gray-100">
                <div class="font-semibold text-gray-800">Productos mas vendidos</div>
            </header>
                ...
                <table class="table-auto w-full">
                    <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                        <tr>
                            ...
                            <th class="p-2">
                                <div class="font-semibold text-left">Total vendido</div>
                            </th>
                            <th class="p-2">
                                <div class="font-semibold text-left">Cantidad existente</div>
                            </th>
                        </tr>
                    </thead>
			...
			if($stmt->rowCount() > 0) {
                ...
                <td class="p-2">
                      <div class="text-center"><?php echo $cantidadexistente; ?></div>
                </td>
...
<div class="flex flex-col justify-top h-max">
        ...
        <header class="px-5 py-4 border-b border-gray-100">
                <div class="font-semibold text-gray-800">Compras recientes</div>
            </header>
            ...
            <div class="overflow-x-auto p-3">
                <table class="table-auto w-full">
                    <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                        <tr>
                            <th class="p-2">
                            <div class="font-semibold text-left">Id Compra</div>
                            </th>
                            <th class="p-2">
                                <div class="font-semibold text-left">Nombre</div>
                            </th>
                            <th class="p-2">
                                <div class="font-semibold text-left">Cantidad compra</div>
                            </th>
                            <th class="p-2">
                ...
                <?php
			$query = "SELECT c.IdCompra,b.Nombre, c.CantidadCompra,c.FechaCompra  FROM `detallecompra` a INNER JOIN producto b on a.IdProducto = b.IdProducto INNER JOIN compra c on a.IdCompra = c.IdCompra ORDER BY C.IdCompra DESC LIMIT 0,3;";
			$stmt = $DBcon->prepare($query);
			$stmt->execute();
			...
			if($stmt->rowCount() > 0) {
				...
				<tr>
                <td class="p-2">
                      <div class="text-left"><?php echo $IdCompra; ?></div>
                </td>
                <td class="p-2">
                      <div class="text-left"><?php echo $Nombre; ?></div>
                </td>
                ...
                <td class="p-2">
                      <div class="text-center"><?php echo $CantidadCompra; ?></div>
                </td>

                <td class="p-2">
                      <div class="text-left font-medium text-green-500" ><?php echo $FechaCompra; ?></div>
                </td>
...
<div class="flex flex-col justify-top h-max">
        ...
        <header class="px-5 py-4 border-b border-gray-100">
                <div class="font-semibold text-gray-800">Clientes mas frecuentes</div>
            </header>
			...
			if($stmt->rowCount() > 0) {
				...
				<tr>
                <td class="p-2">
                      <div class="text-left"><?php echo $NIT; ?></div>
                </td>
                <td class="p-2">
